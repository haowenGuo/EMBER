...
OUT_DIR="$EVAL_DIR/outputs/final_ember300_qwen3_4b_qwen3_5_9b_attacker_${STAMP}"
LOG_DIR="$ROOT/logs"
LOG_FILE="$LOG_DIR/final_ember300_qwen3_4b_qwen3_5_9b_attacker_${STAMP}.log"
PID_FILE="$LOG_DIR/final_ember300_qwen3_4b.pid"
