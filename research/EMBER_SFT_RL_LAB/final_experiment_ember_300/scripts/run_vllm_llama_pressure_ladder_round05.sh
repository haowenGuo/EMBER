...
LOG_DIR="$ROOT/logs"
LOG_FILE="$LOG_DIR/vllm_llama_pressure_ladder_round05_${STAMP}.log"
PID_FILE="$LOG_DIR/vllm_llama_pressure_ladder_round05.pid"
...
(
  env \
    RUN_NAME="vllm_llama_pressure_ladder_round05" \
    STAMP="$STAMP" \
...
echo "Log: $LOG_FILE"
echo "Run root: $ROOT/final_experiment_ember_300/results/vllm_llama_pressure_ladder_round05_${STAMP}"
