...
OUT_DIR="$EVAL_DIR/outputs/final150_round05_llama3_1_8b_base_prompt_agent_pressure_ladder_${STAMP}"
LOG_DIR="$ROOT/logs"
LOG_FILE="$LOG_DIR/final150_round05_llama3_1_8b_pressure_ladder_${STAMP}.log"
PID_FILE="$LOG_DIR/final150_round05_llama3_1_8b_pressure_ladder.pid"
...
COMMON_ARGS=(
  ...
  --attack-prompt-profile pressure_ladder
  --output-dir "$OUT_DIR"
)
