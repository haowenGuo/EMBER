...
GEMINI_BASE_URL = "https://api.gptsapi.net"
...
MODELS_TO_TEST = [
    ...
    "gpt-5-nano",
    "/data2/guohaowen_data/.cache/huggingface/hub/models--Qwen--Qwen3-4B-Instruct-2507/snapshots/cdbee75f17c01a7cc42f958dc650907174af0554",
