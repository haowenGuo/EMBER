# Clean Subagent Task: Expanded Simplified Prompt Blind Review
...
- `qwen_biasexpert_prompt_simplified.md`
...
Output one JSON object per input row to the matching file under `agent_scores/`, e.g. `agent_scores/batch_0006_scores.jsonl`.
